	...
	static class UserRegistration
	{
		public static void Start()
		{
			...
			do
			{
				...
				{
					Console.WriteLine("Invalid email. Please ensure the email is propperly fromatted and press any key to try again.");
					Console.ReadKey();
					email = ReadInputOrCancel("Please enter your email address and press enter to confirm or press Esc to cancel.");
					if (email == null)
					{
						Console.WriteLine("Registration cancelled.");
						return;
