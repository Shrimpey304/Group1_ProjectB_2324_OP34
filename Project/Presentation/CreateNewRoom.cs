...
public class CreateNewRoom{
    ...
    public static void MakeNew(){
        ...
        Console.WriteLine("how many rows do you want to have? (horizontal amount of seats)");
        ...
        Console.WriteLine("how many columns do you want to have? (vertical amount of seats)");
