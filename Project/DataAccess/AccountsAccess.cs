...
{
    static string path = System.IO.Path.Combine(Environment.CurrentDirectory, @"C:\Users\aidan\OneDrive\Documenten\Code files\Hoopschijt\DataSources\accounts.json");
